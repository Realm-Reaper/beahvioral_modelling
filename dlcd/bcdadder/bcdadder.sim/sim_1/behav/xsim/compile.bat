...
REM
REM Generated by Vivado on Fri Jun 19 00:16:05 +0530 2026
...
echo "xvlog --incr --relax -prj bcdadder_tb_vlog.prj"
call xvlog  --incr --relax -prj bcdadder_tb_vlog.prj -log xvlog.log
